...
public class CreateCalendarEventPage extends  CalendarEventPage{
    ...
    public WebElement saveAndCloseMenu;

//        public WebElement SaveAndCloseMenuOption(String option){
//            WebElement saveAndClose = Driver.get().findElement(By.)
//        }
